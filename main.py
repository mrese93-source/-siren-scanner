...
# ----------------------------
# Railway Web Server (must listen on PORT)
# ----------------------------
...
def scan():
    ...
    if market_alert:
        ...
        print("Market alert sent", flush=True)
    ...
    for t in tickers:
        try:
            ...
            if vol_spike >= 5 and change_24h >= 0:
                long_signals.append(("Volume x" + str(round(vol_spike, 1)) + " מהרגיל 💥", 3))
            ...
            if vol_spike >= 5 and change_24h <= 0:
                short_signals.append(("Volume x" + str(round(vol_spike, 1)) + " מהרגיל 💥", 3))
            elif vol_spike >= 3 and change_24h <= 0:
            ...
            if oi_trend >= 3 and abs(change_15m) < 2:
                short_signals.append(("OI עולה בשקט - לחץ שורטים 🔍", 3))
            ...
            msg = (
                ...
                + "💵 מחיר: $" + str(price) + "\n"
                + "📦 Volume: $" + str(round(volume / 1000000, 1)) + "M (x" + str(round(vol_spike, 1)) + ")\n"
